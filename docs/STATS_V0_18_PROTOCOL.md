...
## Secondary diagnostic, added during control training before any v18 test results

Evaluate final curriculum and final shuffled control on the fixed historical v17 96-question eight-family set. This addresses the concrete remaining risk that success on simplified chains fails to transfer to affine second moments or loses previously learned families. Reuse v15's historical responses only after checking exact question/prompt hashes, adapter hash and frozen scores. Generate both new candidates' responses afresh. This diagnostic cannot change training, stopping, checkpoint selection or the primary frozen test. It is historical transfer evidence, not a newly untouched benchmark. Old 240-question MC retention is not remeasured in v18.

...
FROZEN_EVAL = [
    ("distributions_expectation", "A Poisson variable has mean 7. What is its variance?", ["A. 49", "B. 7", "C. sqrt(7)", "D. 1/7"], "B"),
    ...
    ("distributions_expectation", "If E[X]=4 and Y=5X-3, what is E[Y]?", ["A. 8", "B. 17", "C. 20", "D. 23"], "B"),
    ...
    ("distributions_expectation", "A continuous uniform variable spans [-3,5]. Its expectation is:", ["A. -3", "B. 0", "C. 1", "D. 2"], "C"),
    ...
    ("distributions_expectation", "A Poisson count has variance 11. Its mean is:", ["A. sqrt(11)", "B. 11", "C. 121", "D. Cannot be known"], "B"),
    ...
    ("inference_testing", "All else equal, a 90% interval compared with a 95% interval is usually:", ["A. wider", "B. narrower", "C. identical", "D. undefined"], "B"),

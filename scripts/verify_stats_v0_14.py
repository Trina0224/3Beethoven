...
from run_stats_v0_14 import ROOT,build,prompt,score
...
def main():
    ...
    print('V14 VERIFIED',json.dumps(output['verification']),flush=True)
    print('V14 EXPORT',json.dumps(output),flush=True)
